...
public class Slot2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            print("In Inventory");
            Current.transform.position = new Vector3(reftoControls.myCamera.transform.position.x - 7, reftoControls.myCamera.transform.position.y + 4, 0);
        }

        if (reftoControls.SlotSelected == 2)
        {
