...
public class Slot5 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            print("In Inventory");
            Current.transform.position = new Vector3(reftoControls.myCamera.transform.position.x - 4, reftoControls.myCamera.transform.position.y + 4, 0);
        }

        if (reftoControls.SlotSelected == 5)
        {
