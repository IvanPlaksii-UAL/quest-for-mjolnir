...
public class Slot4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            print("In Inventory");
            Current.transform.position = new Vector3(reftoControls.myCamera.transform.position.x - 5, reftoControls.myCamera.transform.position.y + 4, 0);
        }

        if (reftoControls.SlotSelected == 4)
        {
